...
export const HYPOTHESES = [
  ...
  },
  {
    ...
    status: "testable",
    statusNote:
      "Testé sur 5 variables territoriales réelles (chômage, défaillances d'entreprises, logements autorisés, créations d'entreprises, population), avec retrait de tendance par département avant tout test (§5.2) : réseau réel des 96 départements de métropole (contours IGN) contre une grille régulière de contrôle. 2 des 5 vont à l'encontre de H2 -- pas 5 épisodes indépendants au sens du §5.7, mais plus qu'une seule variable.",
