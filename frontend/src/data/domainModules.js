...
export const BANC_ESSAI_MODULES = [
  {
    ...
    status: "comparatif",
    statusNote: "Résultat asymétrique et testé sur les 4 hypothèses qui en avaient le plus besoin (H1, H2, H3, Fusion) : l'IA gagne nettement dans certains cas (H3), perd nettement dans d'autres (H2), et sur données réelles, elle ne fait souvent ni mieux ni pire que les statistiques classiques -- jamais un vainqueur unique. Détail complet, hypothèse par hypothèse, sur la page du résultat.",
